...
"}")
        ...
        self.step_label = QtGui.QLabel(self.background)
    ...
    def retranslateUi(self, TaskWidget):
        ...
        self.step_label.setText(QtGui.QApplication.translate("TaskWidget", "Step", None, QtGui.QApplication.UnicodeUTF8))
